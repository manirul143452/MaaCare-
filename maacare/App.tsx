...
const ParentsPark = lazy(() => import('./components/ParentsPark'));
const PrenatalYoga = lazy(() => import('./components/PrenatalYoga'));
const NutritionGuide = lazy(() => import('./components/NutritionGuide'));
const VaccinationTracker = lazy(() => import('./components/VaccinationTracker'));
const FamilyPlanning = lazy(() => import('./components/FamilyPlanning'));
const Contraception = lazy(() => import('./components/Contraception'));
const DoctorRegister = lazy(() => import('./components/DoctorRegister'));
const DoctorProfile = lazy(() => import('./components/DoctorProfile'));
const ExpertConsultation = lazy(() => import('./components/ExpertConsultation'));
const PregnancyTracker = lazy(() => import('./components/PregnancyTracker'));
...
const ChildCareGuide = lazy(() => import('./components/ChildCareGuide'));
const SelfCare = lazy(() => import('./components/SelfCare'));
const Auth = lazy(() => import('./components/Auth'));
const ProfileView = lazy(() => import('./components/ProfileView'));
const Subscriptions = lazy(() => import('./components/Subscriptions'));
const SettingsView = lazy(() => import('./components/SettingsView'));
const PrivacyPolicy = lazy(() => import('./components/PrivacyPolicy'));
const BrandedLogo = lazy(() => import('./components/BrandedLogo'));
    ...
    <div className="flex h-screen bg-[#fffafb] overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-8">
          <Suspense fallback={<div className="p-6">Loading...</div>}>{renderView()}</Suspense>
        </div>
      </main>
    </div>
  );
